...
sys.path.append("./")
from scripts.demo import mutliapp, demo__intro, demo__voxelmorph, demo__inverse, demo__mnist_inv, demo__mnist_vxm, demo__brain_vxm, demo__brain_inv, demo__analyses
...
app.add_app("Analysis and Results", demo__analyses.app)
app.run()